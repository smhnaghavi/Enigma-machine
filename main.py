...
alphabet = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.,'!؟? 0ابپتثجچحخدذرزژسشصضطظعغفقکگلمنوهی123456789۰۱۲۳۴۵۶۷۸۹"

f = open('./todays_rotor_generator.enigma', 'rb')
...
plain = str(input('Enter your phrase.>> '))
cipher = ''
state = 0
for c in plain:
    state += 1
